...
public class RobotContainer {
        ...
        private final Command m_autoLeft = new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                new AdjustArm2(Constants.ArmConstants.pivotBottomAngle, 0.25,
                                                        ArmMoveType.returnHome),
                                ...
                                new AutoDrive(List.of(
                                (new Pose2d(-2, 0, new Rotation2d(0))),
                                (new Pose2d(-4, 0, Rotation2d.fromDegrees(-180 - 23)))), true)
        ...
        private final Command m_autoCenterTest = new SequentialCommandGroup(
                        ...
                        new WaitCommand(0.75), // was 1
                        new AutoDrive(List.of((new Pose2d(-3.6, 0, new Rotation2d(0))),
                                        (new Pose2d(-4.75, 0, new Rotation2d(0)))
                        // (new Pose2d(-3.5,0, new Rotation2d(0)))
                        ), true),

                        new AutoDrive(List.of((new Pose2d(-4.75, 0, new Rotation2d(0))),
                                        (new Pose2d(-2.7, 0, new Rotation2d(0)))), false),
                        // old 2.7
                        new BalanceRobotCommand()
        ...
        private final Command m_autoRight = new SequentialCommandGroup(
                        ...
                        // new AdjustArm2(94, 28.5,ArmMoveType.dropPiece),
                        // new WaitCommand(0.5),
                        // new AdjustArm2(Constants.ArmConstants.pivotBottomAngle,
                                        // 0.25,ArmMoveType.returnHome),
                        ...
                        (new Pose2d(-4.9, 0.3, Rotation2d.fromDegrees(180 + 23)))
                        // old -4.7
                        ), true),
        ...
        // Negative y value will move Right relative to driver - e.g. (new Pose2d(-3,
        // -0.153, new Rotation2d(Math.PI)))),true) should move .153m to the right
        ...
        public RobotContainer() {
                ...
                LimelightHelpers.setCameraMode_Processor("limelight"); // wass Driver
                LimelightHelpers.setLEDMode_ForceOn("limelight"); // was ForceOff
        ...
        private void configureButtonBindings() {
                ...
                lowPos.onTrue(new SequentialCommandGroup(
                                new AdjustArm2(Constants.ArmConstants.pivotBottomAngle + 4.0, 0.25,
                                                ArmMoveType.setPosition),
                ...
                medPos.onTrue(new SequentialCommandGroup(
                                new AdjustArm2(Constants.ArmConstants.pivotBottomAngle + 4.0, 0.25,
                                                ArmMoveType.setPosition),
                                new AdjustArm2(Constants.ArmConstants.pivotBottomAngle + 42.75, 0,
                                                ArmMoveType.setPosition),
                ...
                groundPickUp.onFalse(
                                new AdjustArm2(Constants.ArmConstants.pivotBottomAngle + 4, 0.25,
                                                ArmMoveType.placeOnRobot));
